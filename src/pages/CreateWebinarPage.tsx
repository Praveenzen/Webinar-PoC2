...
export function CreateWebinarPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(error.message || 'Failed to create webinar')
    } finally {
      setLoading(false)
    }
  }
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">Fill in the details to create your webinar</p>
          </div>
